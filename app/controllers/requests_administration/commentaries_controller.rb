class RequestsAdministration::CommentariesController < ApplicationController
  ...
  def index
    @requests_administration_commentaries = RequestsAdministration::Commentary.all

    respond_to do |format|
      format.html # index.html.erb
      format.xml  { render :xml => @requests_administration_commentaries }
    end
  end
  ...
  def show
    @requests_request_commentary =     @requests_administration_commentaries = RequestsAdministration::Commentary.find(params[:id])
  ...
  def new
    @requests_request_commentary = RequestsAdministration::Commentary.new
  ...
  def edit
    @requests_request_commentary = RequestsAdministration::Commentary.find(params[:id])
  end

  # POST /requests/request_commentaries
  # POST /requests/request_commentaries.xml
  def create
    @requests_request_commentary = RequestsAdministration::Commentary.new(params[:requests_request_commentary])
  ...
  def destroy
    @requests_request_commentary = RequestsAdministration::RequestCommentary.find(params[:id])
